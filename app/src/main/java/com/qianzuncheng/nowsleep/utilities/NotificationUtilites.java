...
import static com.qianzuncheng.nowsleep.utilities.Constants.FIRST_NOTIFICATION_ALARM_REQUEST_CODE;
...
import static com.qianzuncheng.nowsleep.utilities.Constants.ONE_DAY_MILLIS;
...
public class NotificationUtilites {
    ...
    public static void setNotifications_DEBUG(boolean nextDay, boolean notificationsEnabled, int[] bedtime, int notificationDelay, int numNotifications, Context context) {
        if (notificationsEnabled) {
            Calendar bedtimeCalendar = getBedtimeCal(bedtime);
            ...
            try {
                ...
                Log.e("DEBUG", "setNotifications_DEBUG: " + e.toString());
            }
        }
    }
}
